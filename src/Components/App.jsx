    ...
    <div>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route
            path="/Home"
            element={<HomePage value={mainData} setValue={SetmainData} />}
          ></Route>
          <Route
            path="/Calender"
            element={<Calender value={mainData} setValue={SetmainData} />}
          ></Route>
          <Route
            path="Teams"
            element={<Teams value={mainData} setValue={SetmainData} />}
          ></Route>
          <Route
            path="Teams/:teamname"
